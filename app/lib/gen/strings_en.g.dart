...
class TranslationsNetworkInterfacesPageEn {
  ...
  /// en: 'By default, CN Drop uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, CN Drop uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class TranslationsReceiveOptionsPageEn {
  ...
  /// en: '(CN Drop folder)'
  String get appDirectory => '(CN Drop folder)';
...
class TranslationsWebSharePageEn {
  ...
  /// en: 'CN Drop uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'CN Drop uses a self-signed certificate. You need to accept it in your browser.';
...
class TranslationsDonationPageEn {
  ...
  /// en: 'CN Drop is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'CN Drop is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class TranslationsSettingsTabGeneralEn {
  ...
  /// en: 'Show CN Drop in context menu'
  String get showInContextMenu => 'Show CN Drop in context menu';
...
class TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  /// en: 'CN Drop can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'CN Drop can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class TranslationsDialogsSendModeHelpEn {
  ...
  /// en: 'Recipients who do not have CN Drop installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have CN Drop installed can download the selected files by opening the link in their browser.';
}
