...
class $AssetsImgGen {
  ...
  /// File path: assets/img/logo-5122.png
  AssetGenImage get logo5122 => const AssetGenImage('assets/img/logo-5122.png');

  /// File path: assets/img/logo.ico
  String get logo => 'assets/img/logo.ico';

  /// List of all assets
  List<dynamic> get values => [logo128, logo256, logo32Black, logo32White, logo32, logo512White, logo512, logo5122, logo];
}
